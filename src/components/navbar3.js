...
const Navbar3 = (props) => {
  return (
    <header className="navbar3-container">
      ...
      <span className="navbar3-link1 thq-body-small thq-link">
        {props.link1}
      </span>
      <header data-thq="thq-navbar" className="navbar3-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navbar3-desktop-menu">
          <nav className="navbar3-links">
            <span className="navbar3-link11 thq-body-small thq-link">
              {props.link1}
            </span>
            <span className="navbar3-link4 thq-body-small thq-link">
              {props.link4}
            </span>
            <span className="navbar3-link2 thq-body-small thq-link">
              {props.link2}
            </span>
            <span className="navbar3-link3 thq-body-small thq-link">
              {props.link3}
            </span>
            <span className="navbar3-link5 thq-body-small thq-link">
              {props.link5}
            </span>
          </nav>
          ...
          <div className="navbar3-nav">
            <div className="navbar3-top">
              ...
              <div data-thq="thq-close-menu" className="navbar3-close-menu">
                <svg viewBox="0 0 1024 1024" className="navbar3-icon10">
